...
- Timestamp: `2022-05-12 04:29`
- Build ID: `bcd0f71f-e426-4bde-9a67-e6e8a0ae452c`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/bcd0f71f-e426-4bde-9a67-e6e8a0ae452c.git
$ cd bcd0f71f-e426-4bde-9a67-e6e8a0ae452c
```
